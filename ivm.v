...
ordering for [output] as well. The I/O monad will be based on the identity
monad, but the definition makes sense for any base monad [m]: *)

Section io_monad_section.
  (* begin hide *)
  (* Avoid using the name H for this hypothesis. *)
